...
class PixelObject {
    ...
    _setupAnimStart(type, isAnim2 = false) {
        ...
        // Logika SLIDE asli (tidak diubah)
    ...
    draw() {
        ...
        if (this.type === 'group') {
            ...
            ctx.translate(sX, sY); this.children.forEach(c => { let oX = c.x, oY = c.y; c.x = this.x + c.x; c.y = this.y + c.y; c.draw(); c.x = oX; c.y = oY; }); ctx.translate(-sX, -sY);
    ...
    reader.onload = function(e) {
        ...
        lines.forEach(line => {
            ...
            if (cmd === 'TRIG') {
                ...
                let cX = parseInt(tk[10]) || 0;
                let cY = parseInt(tk[11]) || 0;
                
                let o = new PixelObject(tk[1], tk[2], cX, cY);
